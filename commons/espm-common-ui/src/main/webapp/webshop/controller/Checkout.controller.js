	...
	return Controller.extend("com.sap.espm.shop.controller.Checkout", {
		...
		onInit:function()
		{
			...
			var oCheckoutTemplate = new sap.m.ColumnListItem({
				cells:[
					new sap.m.Image({
						src : "/espm-cloud-web-neo/images/{PictureUrl}",
						decorative : false,
						densityAware : false,
						height : "3rem",
						width : "3rem"
		...
		createCustomer: function(){
            ...
            dataType: "json",
            url: "/espm-cloud-web-neo/espm.svc/Customers",
		...
		createSalesOrder: function(){
            ...
            contentType:"application/json; charset=utf-8",
            dataType: "json",
            url: "/espm-cloud-web-neo/espm.svc/SalesOrderHeaders",
            ...
            success: function(oData) {
            		...
            		$.ajax({
			            ...
			            async: true,
			            contentType:"application/json; charset=utf-8",
			            url: "/espm-cloud-web-neo/espm.svc/SalesOrderHeaders('" + oData.d.SalesOrderId + "')/$links/Customer",
			            ...
			            success: function() {
			            	...
			            	$.ajax({
					            ...
					            contentType:"application/json; charset=utf-8",
					            dataType: "json",
					            url: "/espm-cloud-web-neo/espm.svc/GetSalesOrderItemsById?SalesOrderId='"+ oData.d.SalesOrderId +"'",
					            success: function(data) {
					            	...
					            	for(var j=0;j<length;j++){
					            		...
					            		$.ajax({
								            ...
								            dataType: "json",
								            contentType:"application/json; charset=utf-8",
								            url: "/espm-cloud-web-neo/espm.svc/SalesOrderItems(ItemNumber=" + data.d.results[j].ItemNumber + ",SalesOrderId='"+ data.d.results[j].SalesOrderId + "')/$links/Product",
